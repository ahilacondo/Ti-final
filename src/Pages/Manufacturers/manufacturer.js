      ...
      <div className="row d-flex align-items-start">
        <div className="col-12 col-md-6">
          <span className="d-flex justify-content-around">
            <span className="text-center heading">Productos Agrícolas</span>
                ...
                <CardBody>
                  <CardTitle className="">
                    ...
                    <div className="text-center">
                      <span className="badge bg-dark">Proveedores</span>
                      <br/>
        ...
        <div className="col-12 col-md-6">
          <span className="d-flex justify-content-around align-items-center">
            <span className="text-center heading">Productos Finales</span>
